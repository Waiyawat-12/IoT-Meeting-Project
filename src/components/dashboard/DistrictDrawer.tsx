...
export function DistrictDrawer() {
  const { selectedDistrict, selectDistrict } = useFlood();
  const open = Boolean(selectedDistrict);

  return (
    <aside
      className={cn(
        "fixed inset-y-0 right-0 z-40 flex w-full max-w-md flex-col border-l border-white/10 bg-slate-950/95 shadow-2xl backdrop-blur-2xl transition-transform duration-300",
        ...
        <>
          <div className="flex items-start justify-between gap-3 border-b border-white/10 px-5 py-4">
            <div>
              ...
              <p className="text-lg text-slate-300">{selectedDistrict.nameTH}</p>
